...
#region Open
    ...
    [MenuItem("NGUI/Open/Texture Compressor", false, 9)]
    [MenuItem("Assets/NGUI/Open Texture Compressor", false, 0)]
    static public void OpenTextureCompressor()
    {
        EditorWindow.GetWindow<UITextureCompressor>(false, "Texture Compressor", true).Show();
    }
    //End Taesang
