...
#region Convenience accessor properties
	...
	static public bool compressAtlas
	{
		get { return GetBool("Compress Atlas", false); }
		set { SetBool("Compress Atlas", value); }
	}
	//Taesang End
	
	//Taesang CompressTexture
	static public UICompressTextureList compressTextureList
	{
		get { return Get<UICompressTextureList>("Compress Texture List", null); }
		set { Set("Compress Texture List", value); }
	}
	
	static public UICompressTextureList mainCompressTextureList
	{
		get { return Get<UICompressTextureList>("Main Compress Texture List", null); }
		set { Set("Main Compress Texture List", value); }
	}

    static public bool shareAlpha
    {
        get { return GetBool("share Alpha", false); }
        set { SetBool("share Alpha", value); }
    }

    static public string errorRange
    {
        get { return GetString("error range", "0"); }
        set { SetString("error range", value);  }
    }

    //static public AlphaTextureData alphaTextureList
    //{
    //    get { return Get<AlphaTextureData>("Alpha Texture List", null); }
    //    set { Set("Alpha Texture List", value); }
    //}
    //Taesang End
	
	//Taesang remove edge
	static public bool removeEdge
	{
		get { return GetBool("NGUI removeEdge", false); }
		set { SetBool("NGUI removeEdge", value); }
	}
	//Taesang End
