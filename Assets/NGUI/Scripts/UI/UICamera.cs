...
public class UICamera : MonoBehaviour
{
    ...
    public delegate SettableTouch DGetInputTouch(int index);
    public delegate int DGetInputTouchCount();

    static public DGetInputTouch GetInputTouch = null;
    static public DGetInputTouchCount GetInputTouchCount = null;    
#endif
	...
	public void ProcessTouches ()
	{
...
#if USING_AndroidKeyboard
        // yksachi : 현재버전 3.7.6 인데 plugin 버전은 3.8.0인 관계로
        int _touchCount = (GetInputTouchCount == null) ? Input.touchCount : GetInputTouchCount();
        for (int i = 0; i < _touchCount; ++i)
        {
            ...
            {
                SettableTouch touch = GetInputTouch(i);
